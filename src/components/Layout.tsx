...
import { Package, ShoppingCart, BarChart3, Users, Truck, DollarSign, Menu, X, Navigation, Tag, FileText, Video, Wrench } from 'lucide-react'
    ...
    <div className="layout">
      ...
      <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          ...
          <Link
            to="/tutoriales"
            className={`nav-item ${isActive('/tutoriales') ? 'active' : ''}`}
          >
            <Video size={20} />
